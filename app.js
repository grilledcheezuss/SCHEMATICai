// --- SCHEMATICA ai v2.6.4 (fix left sidebar Custom PDF Info scrolling/cutoff; rename section + add header preview button; fix tablet layout shift/gap via flex; align preview modal X styling; version bump) ---
